...
class llc_rtl_top : public ncsc_foreign_module {
  public:
    ...
    llc_rtl_top(sc_module_name name) :
        ncsc_foreign_module(name), clk("clk"), rst("rst"), llc_req_in_valid("llc_req_in_valid"),
        llc_req_in_data_coh_msg("llc_req_in_data_coh_msg"),
        llc_req_in_data_hprot("llc_req_in_data_hprot"),
        llc_req_in_data_addr("llc_req_in_data_addr"), llc_req_in_data_line("llc_req_in_data_line"),
        llc_req_in_data_req_id("llc_req_in_data_req_id"),
        llc_req_in_data_word_offset("llc_req_in_data_word_offset"),
        llc_req_in_data_valid_words("llc_req_in_data_valid_words"),
        llc_req_in_ready("llc_req_in_ready"), llc_dma_req_in_valid("llc_dma_req_in_valid"),
        ...
        llc_dma_req_in_ready("llc_dma_req_in_ready"), llc_rsp_in_valid("llc_rsp_in_valid"),
        llc_rsp_in_data_coh_msg("llc_rsp_in_data_coh_msg"),
        llc_rsp_in_data_addr("llc_rsp_in_data_addr"), llc_rsp_in_data_line("llc_rsp_in_data_line"),
        llc_rsp_in_data_req_id("llc_rsp_in_data_req_id"), llc_rsp_in_ready("llc_rsp_in_ready"),
        llc_mem_rsp_valid("llc_mem_rsp_valid"), llc_mem_rsp_data_line("llc_mem_rsp_data_line"),
        llc_mem_rsp_ready("llc_mem_rsp_ready"), llc_rst_tb_valid("llc_rst_tb_valid"),
        llc_rst_tb_data("llc_rst_tb_data"), llc_rst_tb_ready("llc_rst_tb_ready"),
        ...
        llc_rsp_out_ready("llc_rsp_out_ready"), llc_dma_rsp_out_valid("llc_dma_rsp_out_valid"),
        ...
        llc_dma_rsp_out_ready("llc_dma_rsp_out_ready"), llc_fwd_out_valid("llc_fwd_out_valid"),
        llc_fwd_out_data_coh_msg("llc_fwd_out_data_coh_msg"),
        llc_fwd_out_data_addr("llc_fwd_out_data_addr"),
        llc_fwd_out_data_req_id("llc_fwd_out_data_req_id"),
        llc_fwd_out_data_dest_id("llc_fwd_out_data_dest_id"),
        llc_fwd_out_ready("llc_fwd_out_ready"), llc_mem_req_valid("llc_mem_req_valid"),
        llc_mem_req_data_hwrite("llc_mem_req_data_hwrite"),
        llc_mem_req_data_hsize("llc_mem_req_data_hsize"),
        llc_mem_req_data_hprot("llc_mem_req_data_hprot"),
        llc_mem_req_data_addr("llc_mem_req_data_addr"),
        llc_mem_req_data_line("llc_mem_req_data_line"), llc_mem_req_ready("llc_mem_req_ready"),
        llc_rst_tb_done_valid("llc_rst_tb_done_valid"),
        llc_rst_tb_done_data("llc_rst_tb_done_data"), llc_rst_tb_done_ready("llc_rst_tb_done_ready")
#ifdef STATS_ENABLE
        ,
        llc_stats_valid("llc_stats_valid"), llc_stats_data("llc_stats_data"),
...
class llc_wrapper_conv : public sc_module {
  public:
        ...
        cosim("cosim")
    {
        ...
        sensitive << llc_rsp_out_data_conv_coh_msg << llc_rsp_out_data_conv_addr
                  << llc_rsp_out_data_conv_line << llc_rsp_out_data_conv_invack_cnt
                  << llc_rsp_out_data_conv_req_id << llc_rsp_out_data_conv_dest_id
                  << llc_rsp_out_data_conv_word_offset;
        SC_METHOD(thread_llc_dma_rsp_out_data_conv);
        sensitive << llc_dma_rsp_out_data_conv_coh_msg << llc_dma_rsp_out_data_conv_addr
                  << llc_dma_rsp_out_data_conv_line << llc_dma_rsp_out_data_conv_invack_cnt
                  << llc_dma_rsp_out_data_conv_req_id << llc_dma_rsp_out_data_conv_dest_id
                  << llc_dma_rsp_out_data_conv_word_offset;
        SC_METHOD(thread_llc_fwd_out_data_conv);
        sensitive << llc_fwd_out_data_conv_coh_msg << llc_fwd_out_data_conv_addr
                  << llc_fwd_out_data_conv_req_id << llc_fwd_out_data_conv_dest_id;
        SC_METHOD(thread_llc_mem_req_data_conv);
        sensitive << llc_mem_req_data_conv_hwrite << llc_mem_req_data_conv_hsize
                  << llc_mem_req_data_conv_hprot << llc_mem_req_data_conv_addr
                  << llc_mem_req_data_conv_line;
