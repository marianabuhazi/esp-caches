...
class llc_tb : public sc_module {
  ...
  public:
    ...
    // Constructor
    SC_CTOR(llc_tb) :
        clk("clk"), rst("rst"), llc_req_in_tb("llc_req_in_tb"),
        llc_dma_req_in_tb("llc_dma_req_in_tb"), llc_rsp_in_tb("llc_rsp_in_tb"),
        llc_mem_rsp_tb("llc_mem_rsp_tb"), llc_rst_tb_tb("llc_rst_tb_tb"),
        llc_rsp_out_tb("llc_rsp_out_tb"), llc_dma_rsp_out_tb("llc_dma_rsp_out_tb"),
        llc_fwd_out_tb("llc_fwd_out_tb"), llc_mem_req_tb("llc_mem_req_tb"),
    ...
    void evict_prep(addr_breakdown_llc_t addr_base, addr_breakdown_llc_t &addr1,
                    addr_breakdown_llc_t &addr2, int tag_incr1, int tag_incr2, llc_way_t &evict_way,
                    bool update_way);
    ...
    void op_rsp(coh_msg_t rsp_msg, addr_breakdown_llc_t req_addr, line_t req_line,
                cache_id_t req_id);
    void op_dma(mix_msg_t coh_msg, llc_state_t state, bool evict, bool dirty,
                ...
                line_t rsp_line, line_t evict_line, sharers_t sharers, owner_t owner, bool stall);
    ...
    void put_dma_req_in(mix_msg_t coh_msg, addr_t addr, line_t line, llc_coh_dev_id_t cache_id,
