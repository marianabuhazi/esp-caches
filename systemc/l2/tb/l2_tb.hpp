...
// #endif
    ...
    // word_t rand_word();
    void put_cpu_req(l2_cpu_req_t &cpu_req, cpu_msg_t cpu_msg, hsize_t hsize, addr_t addr,
                     word_t word, hprot_t hprot);
    void get_req_out(coh_msg_t coh_msg, addr_t addr, hprot_t hprot);
    void get_rsp_out(coh_msg_t coh_msg, cache_id_t req_id, bool to_req, addr_t addr, line_t line);
