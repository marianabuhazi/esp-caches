...
class l2 : public sc_module {
  ...
  public:
...
#ifdef L2_DEBUG
        ,
        asserts("asserts"), bookmark("bookmark")
#endif
        ,
        flush_done("flush_done"), l2_cpu_req("l2_cpu_req"), l2_fwd_in("l2_fwd_in"),
        l2_rsp_in("l2_rsp_in"), l2_flush("l2_flush"), l2_rd_rsp("l2_rd_rsp"), l2_inval("l2_inval"),
        l2_bresp("l2_bresp"), l2_req_out("l2_req_out"), l2_rsp_out("l2_rsp_out")
#ifdef STATS_ENABLE
        ,
        l2_stats("l2_stats")
#endif
    ...
    void send_rsp_out(coh_msg_t coh_msg, cache_id_t req_id, bool to_req, line_addr_t line_addr,
                      line_t line);

    /* Functions to move around buffered lines */
    void fill_reqs(cpu_msg_t cpu_msg, addr_breakdown_t addr_br, l2_tag_t tag_estall,
    ...
    void put_reqs(l2_set_t set, l2_way_t way, l2_tag_t tag, line_t lines, hprot_t hprot,
    ...
    void tag_lookup(addr_breakdown_t addr_br, bool &tag_hit, l2_way_t &way_hit,
