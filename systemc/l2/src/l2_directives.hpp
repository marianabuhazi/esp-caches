...
#define L2_RESET HLS_DEFINE_PROTOCOL("l2-reset")

/* Debug */

#define REQS_DBG HLS_UNROLL_LOOP(ON, "l2-reqs-output-unroll")

#define BUFS_DBG HLS_UNROLL_LOOP(ON, "l2-bufs-output-unroll")
...
#define TAG_LOOKUP_LOOP HLS_UNROLL_LOOP(ON, "l2-tag-lookup-loop-unroll")

#define TAG_LOOKUP_FWD_LOOP HLS_UNROLL_LOOP(ON, "l2-tag-lookup-fwd-loop-unroll")
...
#define REQS_LOOKUP_LOOP HLS_UNROLL_LOOP(ON, "l2-reqs-lookup-loop-unroll")
...
#define REQS_PEEK_REQ_LOOP HLS_UNROLL_LOOP(ON, "l2-reqs-peek-req-loop-unroll")
...
#define REQS_PEEK_FWD_LOOP HLS_UNROLL_LOOP(ON, "l2-reqs-peek-fwd-loop-unroll")
...
#define FLUSH_LOOP HLS_CONSTRAIN_LATENCY(0, HLS_ACHIEVABLE, "l2-flush-loop-latency")

#define FLUSH_END HLS_DEFINE_PROTOCOL("l2-flush-end-protocol")
...
#define HIT_READ_ATOMIC_S HLS_CONSTRAIN_LATENCY(0, HLS_ACHIEVABLE, "l2-hit-read-atomic-latency")
// bookmark_tmp |= BM_HIT_READ_ATOMIC_S

#define HIT_READ_ATOMIC_EM HLS_CONSTRAIN_LATENCY(0, HLS_ACHIEVABLE, "l2-hit-read-atomic-em-latency")
...
#define HIT_WRITE_S HLS_CONSTRAIN_LATENCY(0, HLS_ACHIEVABLE, "l2-hit-write-latency")
// bookmark_tmp |= BM_HIT_WRITE_S

#define HIT_WRITE_EM HLS_CONSTRAIN_LATENCY(0, HLS_ACHIEVABLE, "l2-hit-write-em-latency")
