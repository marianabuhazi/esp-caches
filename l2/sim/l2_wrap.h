...
class l2_rtl_top : public ncsc_foreign_module {
  public:
    ...
    l2_rtl_top(sc_module_name name) :
        ncsc_foreign_module(name), clk("clk"), rst("rst"), l2_cpu_req_valid("l2_cpu_req_valid"),
        ...
        l2_cpu_req_data_addr("l2_cpu_req_data_addr"), l2_cpu_req_data_word("l2_cpu_req_data_word"),
        l2_cpu_req_data_amo("l2_cpu_req_data_amo"), l2_cpu_req_ready("l2_cpu_req_ready"),
        l2_fwd_in_valid("l2_fwd_in_valid"), l2_fwd_in_data_coh_msg("l2_fwd_in_data_coh_msg"),
        l2_fwd_in_data_addr("l2_fwd_in_data_addr"), l2_fwd_in_data_req_id("l2_fwd_in_data_req_id"),
        l2_fwd_in_ready("l2_fwd_in_ready"), l2_rsp_in_valid("l2_rsp_in_valid"),
        l2_rsp_in_data_coh_msg("l2_rsp_in_data_coh_msg"),
        l2_rsp_in_data_addr("l2_rsp_in_data_addr"), l2_rsp_in_data_line("l2_rsp_in_data_line"),
        l2_rsp_in_data_invack_cnt("l2_rsp_in_data_invack_cnt"), l2_rsp_in_ready("l2_rsp_in_ready"),
        l2_req_out_ready("l2_req_out_ready"), l2_req_out_valid("l2_req_out_valid"),
        l2_req_out_data_coh_msg("l2_req_out_data_coh_msg"),
        l2_req_out_data_hprot("l2_req_out_data_hprot"),
        l2_req_out_data_addr("l2_req_out_data_addr"), l2_req_out_data_line("l2_req_out_data_line"),
        l2_rsp_out_ready("l2_rsp_out_ready"), l2_rsp_out_valid("l2_rsp_out_valid"),
        ...
        l2_rsp_out_data_addr("l2_rsp_out_data_addr"), l2_rsp_out_data_line("l2_rsp_out_data_line"),
        l2_rd_rsp_ready("l2_rd_rsp_ready"), l2_rd_rsp_valid("l2_rd_rsp_valid"),
        l2_rd_rsp_data_line("l2_rd_rsp_data_line"), l2_flush_valid("l2_flush_valid"),
        l2_flush_data("l2_flush_data"), l2_flush_ready("l2_flush_ready"),
        l2_inval_ready("l2_inval_ready"), l2_inval_valid("l2_inval_valid"),
        l2_inval_data_addr("l2_inval_data_addr"), l2_inval_data_hprot("l2_inval_data_hprot"),
        l2_bresp_ready("l2_bresp_ready"), l2_bresp_valid("l2_bresp_valid"),
        l2_bresp_data("l2_bresp_data"), flush_done("flush_done")
#ifdef STATS_ENABLE
        ,
        l2_stats_valid("l2_stats_valid"), l2_stats_data("l2_stats_data"),
...
class l2_wrapper_conv : public sc_module {
  public:
    ...
    SC_CTOR(l2_wrapper_conv) :
        clk("clk"), rst("rst"), flush_done("flush_done"), l2_cpu_req("l2_cpu_req"),
        l2_fwd_in("l2_fwd_in"), l2_rsp_in("l2_rsp_in"), l2_flush("l2_flush"),
        l2_req_out("l2_req_out"), l2_rsp_out("l2_rsp_out"), l2_rd_rsp("l2_rd_rsp"),
        l2_inval("l2_inval"), l2_bresp("l2_bresp")
#ifdef STATS_ENABLE
        ,
        l2_stats("l2_stats")
#endif
        ...
        cosim("cosim")
    {
        ...
        sensitive << l2_req_out_data_conv_coh_msg << l2_req_out_data_conv_addr
                  << l2_req_out_data_conv_line << l2_req_out_data_conv_hprot;
        SC_METHOD(thread_l2_rsp_out_data_conv);
        sensitive << l2_rsp_out_data_conv_coh_msg << l2_rsp_out_data_conv_addr
                  << l2_rsp_out_data_conv_line << l2_rsp_out_data_conv_req_id
                  << l2_rsp_out_data_conv_to_req;
